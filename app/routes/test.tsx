...
import {Markdown, processMarkdown} from "~/helpers/processMarkdown";

const components = {
  ul: (props: any) => <React.Fragment {...props} />,
  ol: (props: any) => <React.Fragment {...props} />,
...
Christay McAuliffe Space Education Center in Pleasant Grove, Utah. He developed
...
Thorium Nova is a lot of games combined together. Like
[Spaceteam](https://spaceteam.ca), the crew has to work together to complete the
mission. Like [Among Us](https://www.innersloth.com/games/among-us/), the game
happens just as much in real space as it does in the computer. Like
[Elite Dangerous](https://www.elitedangerous.com), your crew will explore a
realistic galaxy populated with beautiful, unique worlds and untold mysteries.
...
- Get access to exclusive content and a discount at launch, only available to
...
Development started on Thorium Nova in the Summer of 2020, and will likely
continue for at least a year before a playable demo is made available.
Fortunately, many of the lessons learned during Thorium Classic's development
can speed the development process of Thorium Nova.
