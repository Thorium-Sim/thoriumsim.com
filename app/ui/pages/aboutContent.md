## A Reimagining of Starship Bridge Simulators
...
project looking for contributors! Read the [contributors guide](https://thoriumsim.com/blog/contributing-to-thorium-nova), check out the
...
Many bridge simulators focus only on arcade
...
Thorium Nova keeps the best parts of Thorium Classic intact:
...
- Robust crew simulation, tracking the position and actions of every crew member
  on the ship.
- Ship AI, an expressive event system, and powerful timeline automations make flights possible without flight
  directors.
...
Development started on Thorium Nova in the Summer of 2020. You can run You can download and run the [latest code from Github](https://github.com/thorium-sim/thorium-nova), or run one of the [alpha versions](https://github.com/Thorium-Sim/thorium-nova/releases) that are infrequently released.

Thorium Nova is a part-time, slow-burn project that will take a long time to complete, and challenges with building a 3D universe, ship and crew AI, and show controls are proving difficult. 

That said, the hope is for the game to be complete by 2029.
